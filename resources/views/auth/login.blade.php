                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="relative mb-2">
                        <input id="password" type="password" name="password" required autocomplete="current-password"
                            ...
                            class="w-full text-sm font-sans px-4 py-2 pr-10 rounded-full bg-green-100 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-amber-400" />
                        <button type="button" onclick="togglePassword()"
                            class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-600 hover:text-amber-600">
                    ...
                    <div class="text-right text-sm mb-4">
                        @if (Route::has('password.request'))
                            <a class="text-gray-500 hover:text-amber-500 underline font-sans"
                    ...
                    <button type="submit"
                        class="w-full font-sans font-semibold bg-amber-600 text-white py-2 rounded-full hover:bg-amber-700 transition">LOGIN</button>
                </form>
            </div>
        </div>
    </div>
